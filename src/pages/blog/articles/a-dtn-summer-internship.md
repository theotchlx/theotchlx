...
I had applied to the position, read up on the subject, and there for almost four months, I became part of a tight community of experts, industry professionals, academics and fellow students, all equally as interesting and dedicated as anybody at CERN.
...
Both on the social and cultural level - I had amazing interactions with fascinating Humans in a very far and somewhat different place; and on the technical level - I learnt so much, C, Rust, Nix.., and of course Delay/Disruption-Tolerant Networking!
